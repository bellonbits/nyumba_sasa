...
export default function MessagesClient({ conversations, currentUserId }: MessagesClientProps) {
  return (
    <div className="min-h-screen bg-[#F5F5F8]" style={{ paddingTop: "env(safe-area-inset-top, 0px)" }}>
      <div className="max-w-3xl mx-auto w-full safe-bottom">
        <div className="px-4 sm:px-6 pt-12 md:pt-8 pb-3 border-b border-gray-100 bg-white rounded-t-3xl mt-0 md:mt-4 shadow-sm">
          <h1 className="text-2xl font-bold text-gray-900">Messages</h1>
          <p className="text-gray-400 text-sm mt-0.5">{conversations.length} conversation{conversations.length !== 1 ? "s" : ""}</p>
        </div>

        <div className="bg-white md:rounded-b-3xl md:shadow-sm overflow-hidden">
